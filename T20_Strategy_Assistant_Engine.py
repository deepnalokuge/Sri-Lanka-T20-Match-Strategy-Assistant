...
if st.button("🚀 Generate Match Strategy"):
    ...
    #st.markdown(f"### 🏏 Expected Total to Restrict Opponent: **{int(total_conceded_pred)} runs**")
        ...
        st.markdown(f"- **Strategy:** <span style='color:green; '>{pp_bowl_str}</span>", 
                    unsafe_allow_html=True)
        ...
        st.markdown(f"- **Strategy:** <span style='color:green; '>{mo_bowl_str}</span>", 
                    unsafe_allow_html=True)
        ...
        st.markdown(f"- **Strategy:** <span style='color:green;'>{do_bowl_str}</span>", 
                    unsafe_allow_html=True)
